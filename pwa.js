...
const cacheName = 'Fixit9ExtraXPJulia-2020-10-25 18:20:33.100827'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit9ExtraXPJulia'.length) === 'Fixit9ExtraXPJulia') {
